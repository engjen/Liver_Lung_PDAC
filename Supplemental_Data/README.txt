...
Supplemental_Dataset_1.csv: Patient level data including survival/outcome data, clinical covariates, metastasis site (liver, lung, other), neoadjuvant treatment, primary resection, resection of lung or liver met, histology, GSVA scores for pORG, pSUB and PurIST from primary of met sample, DNA alterations in primary or met (for variants present in >9 patients)
